...
public class DbAuditPlugin extends PluginAdapter {
    ...
    private void generateSetAudit(IntrospectedTable introspectedTable,
        ...
        method.addBodyLine("this.auditModifyerId = audit.getUserId();"); //$NON-NLS-1$
        method.addBodyLine("this.auditModifyAppsvr = audit.getNodeId();"); //$NON-NLS-1$
        method.addBodyLine("this.auditModifyModule = audit.getProgId();"); //$NON-NLS-1$
